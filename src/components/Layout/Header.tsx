...
import { Sun, Moon, Menu, X, TrendingUp, LayoutDashboard, Briefcase, ArrowLeftRight, Star, Settings } from 'lucide-react'
    ...
    <>
      ...
      {mobileOpen && (
        <div className="lg:hidden fixed inset-0 z-40 pt-14" onClick={() => setMobileOpen(false)}>
          ...
          <nav className="relative bg-slate-900 border-r border-slate-800 w-60 min-h-full p-3 space-y-0.5">
      ...
      <div className="hidden lg:flex fixed top-0 left-60 right-0 z-30 items-center justify-end px-6 py-3 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm border-b border-slate-200 dark:border-slate-800 h-14">
